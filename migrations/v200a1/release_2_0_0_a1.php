...
class release_2_0_0_a1 extends \phpbb\db\migration\migration
{
	...
	{
		return isset($this->config['bbguildffxi_version'])
			&& version_compare($this->config['bbguildffxi_version'], '2.0.0-a1', '>=');
	}
	...
	{
		return [
			['config.remove', ['bbguildffxi_version']],
		];
	}

	public function set_version()
	{
		$this->config->set('bbguildffxi_version', '2.0.0-a1');
	}
}
